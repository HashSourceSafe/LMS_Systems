...
using BAL;
/// <summary>
/// Summary description for clsXmlGroupAllotmentDet
/// </summary>
namespace XMLOBJ
{
    public class clsXmlGroupAllotmentDet
    {
        XElement m_XmlRoot;
        XElement m_RowXml;
        int m_ErrorNo;
        public clsXmlGroupAllotmentDet()
        {
            m_XmlRoot = new XElement("GROUP_WISE_STUDENT_DET");
            m_ErrorNo = 0;
        }
        ~clsXmlGroupAllotmentDet()
        {
            m_XmlRoot = null;
            m_RowXml = null;
        }
