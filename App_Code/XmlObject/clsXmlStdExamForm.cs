...
/// <summary>
/// Summary description for clsXmlStdExamForm
/// </summary>
/// 
namespace XMLOBJ
{
    public class clsXmlStdExamForm
    {
        XElement m_XmlRoot;
        XElement m_RowXml;
        int m_ErrorNo;

        public clsXmlStdExamForm()
        {
            //
            // TODO: Add constructor logic here
            //
            m_XmlRoot = new XElement("FORM_DET");
            m_ErrorNo = 0;
        }
        ...
        public void AddBlankRow()
        {
            ...
            try
            {
                m_clsBalCommonLib.CreateXmlElement(m_RowXml, "m_nSubId", 0);
