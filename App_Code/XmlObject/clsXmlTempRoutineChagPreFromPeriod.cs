...
/// <summary>
/// Summary description for clsXmlTempRoutineChagPreFromPeriod
/// </summary>
namespace XMLOBJ
{
    public class clsXmlTempRoutineChagPreFromPeriod
    {
        XElement m_XmlRoot;
        XElement m_RowXml;
        int m_ErrorNo;
        public clsXmlTempRoutineChagPreFromPeriod()
        {
            m_XmlRoot = new XElement("PERIOD_DET");
            m_ErrorNo = 0;
        }
        ~clsXmlTempRoutineChagPreFromPeriod()
        {
            m_XmlRoot = null;
            m_RowXml = null;
        }
        public void AddBlankRow()
        {
            ...
            try
            {
                ...
                m_clsBalCommonLib.CreateXmlElement(m_RowXml, "m_faculty_name", 0);
                m_clsBalCommonLib.CreateXmlElement(m_RowXml, "m_faculty_sh_nam", 0);
