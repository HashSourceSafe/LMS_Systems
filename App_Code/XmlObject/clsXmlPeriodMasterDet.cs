...
/// <summary>
/// Summary description for clsXmlPeriodMasterDet
/// </summary>
namespace XMLOBJ
{

    public class clsXmlPeriodMasterDet
    {
        XElement m_XmlRoot;
        XElement m_RowXml;
        int m_ErrorNo;
        public clsXmlPeriodMasterDet()
        {
            m_XmlRoot = new XElement("PERIOD_DET");
            m_ErrorNo = 0;
        }
        ~clsXmlPeriodMasterDet()
        {
            m_XmlRoot = null;
            m_RowXml = null;
        }
        public void AddBlankRow()
        {
            ...
            try
            {
                ...
                m_clsBalCommonLib.CreateXmlElement(m_RowXml, "m_PeriodStartTime", 0);
                m_clsBalCommonLib.CreateXmlElement(m_RowXml, "m_PeriodEndTime", 0);
                //m_clsBalCommonLib.CreateXmlElement(m_RowXml, "m_PeriodDisplay", 0);
