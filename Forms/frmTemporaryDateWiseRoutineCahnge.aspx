<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmTemporaryDateWiseRoutineCahnge.aspx.cs"
          ...
          <div class="col-md-12">
            ...
            <div>
                ...
                <asp:HiddenField ID="cntxt_save_ctr" Value="0" runat="server" />
                    ...
                    <input type="hidden" id="hiddenCollegeId" value="<%= Session["G_COLLEGE_ID"] %>" />
                    <input type="hidden" id="hiddenUserId" value="<%= Session["G_USER_ID"] %>" />
                    <input type="hidden" id="hiddenUserName" value="<%= Session["G_USER_NAME"] %>" />
                    <input type="hidden" id="hiddenDeptId" value="<%= Session["G_DEPT_ID"] %>" />
