<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmManageUser.aspx.cs" Inherits="Forms_frmManageUser" %>
...
<body onload="SetWindow(1024,768); Init(); PopulateUserDetails();" onkeyup="CheckKeyUp(event);"
        ...
        <form id="form1" runat="server">
            ...
            <asp:ScriptManager ID="m_ScriptManager" runat="server">
                <Services>
                    ...
                    <asp:ServiceReference Path="~/Forms/WebServiceManageUser.asmx" />
                </Services>
            </asp:ScriptManager>
        </div>
            <header id="topnav"> 
       ...
       <div class="row">
          <div class="col-12">
            <div class="page-title-box">
              ...
              <asp:Label ID="lbl_document_name" runat="server"  Text="Manage User" ></asp:Label>
                </span> </h4>
            </div>
          </div>
        </div>
                     <div class="card-box">
                       <div class="row">
                        <div class="col-md-4" id="div_textbox_user">
                            <div class="form-group">
                            <asp:TextBox ID="ctxt_user_name" Placeholder="Enter User Name" CssClass="form-control"
                        ...
                        <div class="col-md-4" id="div3">
                            <div class="form-group">
                            <asp:TextBox ID="ctxt_password" Placeholder="Enter Password"  CssClass="form-control"
                            runat="server"></asp:TextBox>
                        </div>
                            </div>
                        ...
                        <div class="col-md-4" id="div5">
                            <div class="form-group">
                            <asp:TextBox ID="ctxt_faculty_dept" Placeholder="Select Department"  CssClass="form-control text_box mandatory-dropdown" 
                             Onkeyup="PopulateFacultyDept(event); return false;" onclick="PopulateFacultyDept(event); return false;" runat="server"></asp:TextBox>
                            <div id="div_from_faculty_dept" class="div_java_script_combo_sub">
                            </div>
                        </div>
                            </div>
                    </div>
                       <div class="row text-center">
                        <div class="col-md-12">
                            <asp:CheckBox Checked="true" ID="chk_is_user_active" runat="server" Font-Bold="True"
                            ForeColor="#3333CC" Text="Is User Active ?" />
                        </div>
                     </div>
                       <div class="row text-center">
                        <div class="col-md-12">
                     ...
                     <div class="card-box">
                    <div class="" id="div_user_details_container">
                            <div class="table-responsive">
                                <asp:Panel runat="server" ID="m_panel_user_details" CssClass="panel-body" ScrollBars="Vertical">
                                </asp:Panel>
                            </div>
                    </div>
                </div>
            ...
            <div style="display: inherit">
                ...
                <asp:HiddenField ID="cntxt_is_active" runat="server" Value="0" />
                <asp:HiddenField ID="cntxt_flag" runat="server" Value="0" />
            </div>
        </div>
            </div>
            <footer class="footer">
