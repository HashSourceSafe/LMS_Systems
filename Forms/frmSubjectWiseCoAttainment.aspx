<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmSubjectWiseCoAttainment.aspx.cs" Inherits="Forms_frmSubjectWiseCoAttainment" %>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Subject Wise Co Attainment</title>
    ...
    <script type="text/javascript" src="JavaScript/SubjectWiseCoAttainment.js?version=1"></script>    
    ...
    <div class="container-fluid">     
        ...
        <div class="col-12">
          <div class="page-title-box">
            <h4 class="page-title">
              <span> <asp:Label ID="Label5" runat="server"  Text="SUBJECT WISE CO ATTAINMENT" ></asp:Label></span>
            </h4>
          </div>
        </div>
      </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <asp:TextBox ID="ctxt_period" Onkeyup="SearchPeriod(event); return false;" onclick="SearchPeriod(event); return false;"
                                CssClass="form-control" runat="server" Placeholder="Select Batch"></asp:TextBox>
                        ...
                        <div class="col-md-2">
                          ...
                          <div class="col-md-2">
                            ...
                            <asp:TextBox ID="ctxt_subject" Onkeyup="PopulateSubject(event); return false;" onclick="PopulateSubject(event); return false;"
                                CssClass="form-control" runat="server" Placeholder="Select Subject"></asp:TextBox>
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                                    ...
                                    <asp:TextBox ID="ctxt_exam" Onkeyup="PopulateExam(event); return false;" onclick="PopulateExam(event); return false;"
                                        CssClass="form-control" runat="server" Placeholder="Select Exam"></asp:TextBox>
                                    <div id="div_exam" class="div_java_script_combo_sub_right">
                                    </div>
                                  </div>
                         </div>
                  </div>
                       ...
                       <div class="col-md-2">
                             <div class="card-box">
                                <div class="table-responsive">
                                    <asp:Panel runat="server" ID="m_PanelCoList" style="height:400px" >
                                    </asp:Panel>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-10">
                             <div class="card-box">
                                <div class="table-responsive">
                                    <asp:Panel runat="server" ID="m_panel_matrix" style="height:400px;" ScrollBars="Auto">
                                    </asp:Panel>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-12 text-center">
                          <asp:Button ID="cmd_co_attn" runat="server" CssClass="btn btn-primary"
                                OnClientClick="PrintCoAttainment(); return false;" Text="Print CO Attainment" />
