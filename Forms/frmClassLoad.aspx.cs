...
public partial class Forms_frmClassLoad : System.Web.UI.Page
{
    ...
    private void InitPage()
    {
        ...
        try
        {
            if (m_college_id == "0")
            {
                ...
                if (Session["G_BRANCH_ID"].ToString() == "64")
                {
            ...
            else if (cntxt_college_id.Value == "401") //jisu
            {
                Session["G_COLLEGE_ID"] = "401";
                Session["G_BRANCH_ID"] = "401";
                Session["G_COLLEGE_NAME"] = "Asansol";
            }
            ...
            else if (cntxt_college_id.Value == "62") //GMIT
            {
                Session["G_COLLEGE_ID"] = "2";
            ...
            else if (cntxt_college_id.Value == "64") //FCP
            {
            ...
            else if (cntxt_college_id.Value == "51") //Abacus
            {
                Session["G_COLLEGE_ID"] = "1";
            ...
            cntxt_session_id.Value = Session["G_ACADEMIC_SESSION_ID"].ToString();
        }
        catch
        {
        }
