<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPoMaster.aspx.cs" Inherits="Forms_frmPoMaster" %>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <script type="text/javascript" src="JavaScript/PoMaster.js?version=1"></script>   
      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box">
            <h4 class="page-title">
              <span> <asp:Label ID="Label5" runat="server"  Text="PROGRAM OUTCOMES SETTINGS" ></asp:Label></span>
            </h4>
          </div>
        </div>
      </div>
          ...
          <div class="col-sm-12">  
                ...
                <div id="m_UpdatePanelHeader" runat="server">
                  <div class="card-box">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="col-md-4">
                            ...
                            <asp:TextBox ID="ctxt_po_type" Onkeyup="PopulatePoType(event); return false;" onclick="PopulatePoType(event); return false;"
                                CssClass="form-control mandatory-dropdown" runat="server" Placeholder="Select Type"></asp:TextBox>
                            <div id="div_po_type" class="div_java_script_combo_sub">
                            </div>
                          </div>
                        </div>    
                   ...
                   <div class="row">
                         <div class="col-md-2">
                                    <div class="form-group">
                                    <label>Enter SL</label>
                                    <asp:TextBox ID="ctxt_po_sl" 
                                        CssClass="form-control" runat="server" Placeholder="Enter SL"></asp:TextBox>
                                  </div>
                         </div>
                         ...
                         <div class="col-md-3">
                                    ...
                                    <asp:TextBox ID="ctxt_desp" 
                                        CssClass="form-control" runat="server" Placeholder="Enter Description"></asp:TextBox>
                                  </div>
                         </div>
                         ...
                         <div class="col-md-7">
                                    ...
                                    <asp:TextBox ID="ctxt_details" 
                                        CssClass="form-control" runat="server" Placeholder="Enter Details"></asp:TextBox>
                                  </div>
                         </div>
                    </div>

                </div>
                <div id="m_UpdatePanelSearchPo" runat="server">
                    <div class="row">
                        <div class="col-md-12">
                           <div class="card-box">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-12 text-center">
                            <asp:Button ID="cmd_save" runat="server" CssClass="btn btn-primary"
                                OnClientClick="SaveProgramOutcomeMst(); return false;" Text="Save" />
                ...
                <div id="m_UpdatePanelHiddenField" runat="server">
                    <div style="display: inherit">
                        ...
                        <asp:HiddenField ID="cntxt_po_type_id" runat="server" Value="0" />

                        <asp:HiddenField ID="cntxt_po_key_id" runat="server" Value="0" />
