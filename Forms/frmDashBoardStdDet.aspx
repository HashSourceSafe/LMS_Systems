<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDashBoardStdDet.aspx.cs" Inherits="Forms_frmDashBoardStdDet" %>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <script type="text/javascript" src="JavaScript/DashBoardStdDet.js?version=5"></script>
           ...
           <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            <h4 class="page-title"><asp:Label ID="Label5" runat="server"  Text="Student Attendance" ></asp:Label></h4>
                        </div>
                    </div>
                </div>
                  ...
                  <div class="card-box">
                    <div class="row">
                       ...
                       <div class="row">
                        ...
                        <div class="col-md-3">
                        <div class="form-group">
                            <label>Search On Student Name</label>
                            <asp:TextBox ID="ctxt_student_name" placeholder="Student Name" CssClass="form-control" runat="server" ></asp:TextBox>
                          </div>
                        </div>
                        <div class="col-md-3">
                        <div class="form-group">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RadioButtonList ID="radio_sort_on" runat="server" ForeColor="Black" Font-Bold="True"
                                ...
                                <asp:ListItem  Text="Course&nbsp&nbsp"></asp:ListItem>
                                <asp:ListItem  Text="Sch Attd(%) Asc&nbsp&nbsp"></asp:ListItem>
                                <asp:ListItem  Selected="True" Text="Sch Attd(%) Desc"></asp:ListItem>
                            </asp:RadioButtonList>
                          </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <asp:RadioButtonList ID="radio_report_type" runat="server" ForeColor="Black" Font-Bold="True"
                                ...
                                <asp:ListItem Selected="True" Text="Student Wise Summary&nbsp&nbsp"></asp:ListItem>
                                <asp:ListItem  Text="Course+Stream Wise Summary&nbsp&nbsp"></asp:ListItem>
                                <asp:ListItem Text="Student Wise Details&nbsp&nbsp"></asp:ListItem>
                            </asp:RadioButtonList>
                        </div>
                        ...
                        <div class="col-md-4 text-right">
                            ...
                            OnClientClick="DisplayData('0','1'); return false;" Text="Export" />
                        
                            <asp:Button ID="cmd_reset" runat="server" CssClass="btn bg-primary"
