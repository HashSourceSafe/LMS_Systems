<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmCourseOutcomeMaster.aspx.cs" Inherits="Forms_frmCourseOutcomeMaster" %>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Course Outcome Master</title>
    ...
    <script type="text/javascript" src="JavaScript/CourseOutcomeMaster.js?version=1"></script>    
    ...
    <div class="row">
        <div class="col-12">
          <div class="page-title-box">
            <h4 class="page-title">
              <span> <asp:Label ID="Label5" runat="server"  Text="COURSE OUTCOMES SETTINGS" ></asp:Label></span>
            </h4>
          </div>
        </div>
      </div>
      ...
      <div class="row  justify-content-center">
          <div class="col-sm-12">  
                ...
                <div id="m_UpdatePanelSearchCo" runat="server">
                    <div class="row">
                        <div class="col-md-12">
                           <div class="card-box">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-12 text-center">
                            <asp:Button ID="cmd_save" runat="server" CssClass="btn btn-primary"
                                OnClientClick="SaveCourseOutcomeMst(); return false;" Text="Save" />
                ...
                <div id="m_UpdatePanelHiddenField" runat="server">
                    <div style="display: inherit">
                        ...
                        <asp:HiddenField ID="cntxt_co_key_id" runat="server" Value="0" />
