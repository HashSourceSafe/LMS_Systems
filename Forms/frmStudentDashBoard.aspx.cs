...
public partial class Forms_frmStudentDashBoard : System.Web.UI.Page
{
    ...
    private void InitPage()
    {
        ...
        try
        {
            ctxt_student_code.Value = Request.QueryString["code"].ToString();
            ...
            dtp_from_date.Text = m_current_firstfrom_date.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture);
            dtp_to_date.Text = m_current_firstto_date.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture);
            ctxt_current_date.Value = m_current_date.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture);

            cntxt_year.Value = DateTime.Today.Year.ToString();
            cntxt_month.Value = DateTime.Today.Month.ToString();
    ...
    private void CheckSession()
    {
        ...
        if (m_url == null && Session["G_IS_AUTO_LOGIN"].ToString()=="N")
        {
