<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmQuestionPaperSetting.aspx.cs" Inherits="Forms_frmQuestionPaperSetting" %>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <script type="text/javascript" src="JavaScript/QuestionPaperSetting.js?version=1"></script>   
      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box">
            <h4 class="page-title">
              <span> <asp:Label ID="Label5" runat="server"  Text="QUESTION PAPER SETTINGS" ></asp:Label></span>
            </h4>
          </div>
        </div>
      </div>
                ...
                <div id="m_UpdatePanelHeader" runat="server">
                  <div class="card-box">
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <asp:TextBox ID="ctxt_period" Onkeyup="SearchPeriod(event); return false;" onclick="SearchPeriod(event); return false;"
                                CssClass="form-control mandatory-dropdown" runat="server" Placeholder="Select Period"></asp:TextBox>
                   ...
                   <div class="row">
                         ...
                         <div class="col-md-3">
                                    <div class="form-group">
                                    <label>Select Bloom Taxanomy/Level</label>
                                    <asp:TextBox ID="ctxt_bloom" Onkeyup="PopulateBloomTaxanomy(event); return false;" onclick="PopulateBloomTaxanomy(event); return false;"
                                        CssClass="form-control mandatory-dropdown" runat="server" Placeholder="Select Level"></asp:TextBox>
                                    <div id="div_bloom" class="div_java_script_combo_sub">
                                    </div>
                                  </div>
                         </div>
                         ...
                         <div class="col-md-3">
                                    <div class="form-group">
                                    <label>Select Course Outcome(CO)</label>
                                    <asp:TextBox ID="ctxt_co" Onkeyup="PopulateCo(event); return false;" onclick="PopulateCo(event); return false;"
                                        CssClass="form-control mandatory-dropdown" runat="server" Placeholder="Select CO"></asp:TextBox>
                                    <div id="div_co" class="div_java_script_combo_sub_right">
                                    </div>
                                  </div>
                         </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                                ...
                                <asp:TextBox ID="ctxt_question_no" CssClass="form-control" 
                                    runat="server" Placeholder="Eg. Q1,Q2"></asp:TextBox>
                                </div>
                          </div>      
                        ...
                        <div class="col-md-8">
                                ...
                                <asp:TextBox ID="ctxt_question_det"  CssClass="form-control" 
                                    runat="server" Text="" Placeholder="Enter Question"></asp:TextBox>
                                </div>
                          </div>
                        ...
                        <div class="col-md-2">
                                ...
                                <asp:TextBox ID="cntxt_marks" type="number" CssClass="form-control" 
                                    runat="server" Text="0" Placeholder="Enter Marks"></asp:TextBox>
                                </div>
                          </div>                                                              
                ...
                <div id="m_UpdatePanelSearchSubject" runat="server">
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            <asp:Panel runat="server" ID="m_panel_question_search_window">
                            </asp:Panel>
                        ...
                        <div class="col-md-6">
                          <div class="card-box">
                        <div class="table-responsive">
                            <asp:Panel runat="server" ID="m_panel_matrix">
                            </asp:Panel>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-12 text-center">
                            <asp:Button ID="cmd_save" runat="server" CssClass="btn btn-primary"
                                OnClientClick="SaveQuestionMaster(); return false;" Text="Save" />
